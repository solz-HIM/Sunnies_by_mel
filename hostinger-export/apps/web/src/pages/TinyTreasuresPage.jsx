...
import { tinyTreasuresProducts } from '@/data/products.js';

const TinyTreasuresPage = () => {
  const [searchQuery, setSearchQuery] = useState('');

  const filteredProducts = tinyTreasuresProducts.filter(product => 
  ...
  return (
    ...
    >
      <Helmet>
        <title>Sunnies by Mel - Shop Tiny Treasures</title>
        <meta name="description" content="Explore our premium watch collection at Sunnies by Mel. Precision and style combined." />
      </Helmet>
        ...
        >
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <p className="text-xl text-muted-foreground max-w-2xl">
              Precision timepieces. A curation of bold aesthetics and reliable mechanics.
            </p>
...
export default TinyTreasuresPage;